...
<div class="container mt-4">
    ...
    <form method="post" action="{{route('app.divida.store')}}" id="">
        ...
        <div class="form-group">
            ...
            <input name="cliente_id" type="text" value="{{ old('cliente_id') }}" placeholder="Código do Cliente" class="form-control" id="cliente_id" >
            {{ $errors->has('cliente_id') ? $errors->first('cliente_id') : '' }}
        </div>
        <div class="form-group">
            <label for="fornecedor_id">Fornecedor:</label>
            <select name="fornecedor_id" value="{{ old('fornecedor_id') }}" class="form-control" id="fornecedor_id" >
        ...
        <div class="form-group">
            ...
            <input name="data_do_debito" type="date" value="{{ old('data_do_debito') }}"  class="form-control" id="data_do_debito" >
            {{ $errors->has('data_do_debito') ? $errors->first('data_do_debito') : '' }}
        </div>
        <div class="form-group">
            <label for="valor_da_divida">Valor da Divida:</label>
            <input name="valor_da_divida" type="text" value="{{ old('valor_da_divida') }}" placeholder="R$ 0.00" class="form-control" id="valor_da_divida" >
            {{ $errors->has('valor_da_divida') ? $errors->first('valor_da_divida') : '' }}
        </div>
        <div class="form-group">
            <label for="data_de_vencimento">Data de Vencimento:</label>
            <input name="data_de_vencimento" type="date" value="{{ old('data_de_vencimento') }}"  class="form-control" id="data_de_vencimento" >
            {{ $errors->has('data_de_vencimento') ? $errors->first('data_de_vencimento') : '' }}
        </div>
        <div class="form-group">
            <label for="valor_do_acordo">Valor do Acordo:</label>
            <input name="valor_do_acordo" type="text" value="{{ old('valor_do_acordo') }}" placeholder="R$ 0.00" class="form-control" id="valor_do_acordo" >
